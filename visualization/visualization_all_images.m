...
switch mode
  ...
  case 'update'
    ...
    text(size(img,2)/2,3,sprintf('3D Bounding Boxes - stereo images'),'parent',h(4).axes,'color','g','HorizontalAlignment','center','VerticalAlignment','top','FontSize',14,'FontWeight','bold','BackgroundColor','black');
    text(size(img,2)/2,3,sprintf('3D Bounding Boxes - stereo images incorporating disparity'),'parent',h(5).axes,'color','g','HorizontalAlignment','center','VerticalAlignment','top','FontSize',14,'FontWeight','bold','BackgroundColor','black');
